...
@Component({
  selector: 'app-infographic-org-referral-mobile',
  templateUrl: './infographic-org-referral-mobile.component.html',
  styleUrls: ['./infographic-org-referral-mobile.component.scss']
})
export class InfographicOrgReferralMobileComponent implements OnInit {
  ...
  createChart() {
    ...
    this.chart = new Chart('org-referral-graph-mobile', this.configPie);
  }
